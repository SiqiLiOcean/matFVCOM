...
if ismember('SAT', varname)
    SAT_varid = netcdf.defVar(ncid, 'SAT', 'float', [node_dimid time_dimid]);
    netcdf.putAtt(ncid, SAT_varid, 'long_name', 'Sea surface air temperature');
    netcdf.putAtt(ncid, SAT_varid, 'units', 'degree (C)');
end
% SPQ
